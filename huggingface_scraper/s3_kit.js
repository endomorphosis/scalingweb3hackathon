...
export class S3Kit {
  ...
  call(method, kwargs) {
    ...
    s3CpDir(srcPath, dstPath, bucket, kwargs) {
      let s3Config = kwargs && kwargs.s3cfg ? kwargs.s3cfg : this.config;
      let s3 = new AWS.S3(this.configToBoto(s3Config));
      let params = {
        Bucket: bucket,
    ...
    s3MvDir(srcPath, dstPath, bucket, kwargs) {
      let s3Config = kwargs && kwargs.s3cfg ? kwargs.s3cfg : this.config;
      let s3 = new AWS.S3(this.configToBoto(s3Config));
      let params = {
        Bucket: bucket,
    ...
    s3DlDir(remotePath, localPath, bucket, kwargs) {
      let s3Config = kwargs && kwargs.s3cfg ? kwargs.s3cfg : this.config;
      let s3 = new AWS.S3(this.configToBoto(s3Config));
      let params = {
        Bucket: bucket,
    ...
    s3UlDir(localPath, remotePath, bucket, kwargs) {
      let s3Config = kwargs && kwargs.s3cfg ? kwargs.s3cfg : this.config;
      let s3 = new AWS.S3(this.configToBoto(s3Config));
    ...
    s3LsFile(filekey, bucket, kwargs) {
      let s3Config = kwargs && kwargs.s3cfg ? kwargs.s3cfg : this.config;
      let s3 = new AWS.S3(this.configToBoto(s3Config));
      let params = {
        Bucket: bucket,
    ...
    s3RmFile(thisPath, bucket, kwargs) {
      let s3Config = kwargs && kwargs.s3cfg ? kwargs.s3cfg : this.config;
      let s3 = new AWS.S3(this.configToBoto(s3Config));
      let params = {
        Bucket: bucket,
    ...
    s3CpFile(srcPath, dstPath, bucket, kwargs) {
      let s3Config = kwargs && kwargs.s3cfg ? kwargs.s3cfg : this.config;
      let s3 = new AWS.S3(this.configToBoto(s3Config));
      let params = {
        Bucket: bucket,
